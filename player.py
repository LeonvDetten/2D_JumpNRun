...
class Player(pygame.sprite.Sprite):
    ...
    def move_y(self):
        ...
        if self.speed_y >= 0 and collided_y > 0 :#and self.world.check_player_collision_sideblock(self.playerPos) == 1:                  Wenn ELIF Dann in Zeile drüber:       (self.world.check_player_collision_sideblock(self.playerPos) != 1 and self.playerPos.y < 600) and BERÜHRE KEINEN ANDEREN BLOCK                 
