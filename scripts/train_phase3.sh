...
nohup taskset -c 0-2 python3 -m jumpnrun.rl.train --run runs/phase3 --resume models/phase2.zip --target 14000000 \
    --max-tier 9 --threads 3 --eval-per-tier 6 --eval-every 250000 \
